...
const SecondSection = () => {
 ...
 width={1000}
        height={1000}
            ...
            <h2
              className="
                ...
                gap-2 sm:gap-3 
                font-semibold 
        text-[20px] sm:text-[30px] md:text-[35px] lg:text-[40px] xl:text-[50px]
        leading-tight sm:leading-snug lg:leading-[1.1]
            ...
            {/* Contact Info */}
            <div className="flex flex-wrap items-center justify-center text-white gap-2 sm:gap-5 body3 white-text px-4 lg:p-0">
